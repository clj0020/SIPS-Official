...
describe('/users', () => {
	...
	describe('POST :/login', () => {
		...
		it('should fail to Login due to wrong password', (done) => {
			chai.request(server)
				.post('/users/register')
				.send({
					'name': 'Test Name',
		...
		it('should fail to Login due to missing password parameter', (done) => {
			chai.request(server)
				.post('/users/register')
				.send({
					'name': 'Test Name',
		...
		it('should fail to Login due to missing username parameter', (done) => {
			chai.request(server)
				.post('/users/register')
				.send({
					'name': 'Test Name',
		...
		it('should Login successfully and check token', (done) => {
			chai.request(server)
				.post('/users/register')
				.send({
					'name': 'Test Name',
				...
				.end((err, res) => {
					...
					chai.request(server)
						...
						.end((err, res) => {
							...
							res.body.should.have.property('msg');
							res.body.msg.should.be.a('string');
							res.body.msg.should.be.eql('User found!');
